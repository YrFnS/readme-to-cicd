...
interface PreviewToolbarProps {
  ...
  onGenerate: () => void;
  onCancel: () => void;
  onLayoutChange: (layout: Partial<PreviewLayout>) => void;
  ...
  return (
    <div className="preview-toolbar">
      <div className="toolbar-section left">
        ...
        <div className="toolbar-group">
          <button
            className={`toolbar-button ${layout.splitView ? 'active' : ''}`}
          ...
          {layout.splitView && (
            <button
              ...
              title={`Switch to ${layout.orientation === 'horizontal' ? 'vertical' : 'horizontal'} layout`}
            >
            ...
            <div className="toolbar-group">
              <label className="split-control">
                ...
                <input
                  ...
                  min="20"
                  max="80"
                  value={layout.configurationWidth}
                  onChange={(e) => handleSplitResize(parseInt(e.target.value))}
      ...
      <div className="toolbar-section right">
        <div className="toolbar-group">
          <button
            className="toolbar-button generate primary"
            onClick={onGenerate}
            title="Generate and save workflow files"
          >
            <span className="button-icon">🚀</span>
