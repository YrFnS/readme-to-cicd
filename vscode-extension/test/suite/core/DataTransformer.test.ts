...
suite('Data Transformer Tests', () => {
  ...
  const mockExtensionConfiguration: ExtensionConfiguration = {
  ...
  suite('transformConfigurationToCLI', () => {
    test('should transform configuration to CLI request', () => {
      const result = dataTransformer.transformConfigurationToCLI(
    ...
    test('should handle empty frameworks list', () => {
      const configWithNoFrameworks: WorkflowConfiguration = {
        ...mockWorkflowConfiguration,
        frameworks: []
      };

      const result = dataTransformer.transformConfigurationToCLI(
        configWithNoFrameworks,
        mockExtensionConfiguration,
        'README.md',
        '.github/workflows'
      );
  ...
  suite('transformConfigurationToCLIArgs', () => {
    test('should generate correct CLI arguments', () => {
      const result = dataTransformer.transformConfigurationToCLIArgs(
        mockWorkflowConfiguration,
        'README.md',
        '.github/workflows',
        false
    ...
    test('should include optimization level when not standard', () => {
      const configWithOptimization: WorkflowConfiguration = {
        ...mockWorkflowConfiguration,
    ...
    test('should include security level when not standard', () => {
      const configWithSecurity: WorkflowConfiguration = {
        ...mockWorkflowConfiguration,
  ...
  suite('transformCLIResultToExtension', () => {
    test('should parse JSON CLI output', () => {
      ...
      const result = dataTransformer.transformCLIResultToExtension(
        jsonOutput,
        '',
        0
      );
  ...
  suite('Validation', () => {
    test('should validate transformation context', () => {
      const validContext = {
        sourceFormat: 'extension' as const,
        targetFormat: 'cli' as const,
    ...
    test('should reject invalid transformation context', () => {
      const invalidContext = {
        sourceFormat: 'extension' as const,
        targetFormat: 'extension' as const, // Same as source
        operation: 'configuration' as const
      };
