...
suite('GitIntegration Unit Tests', () => {
    ...
    setup(() => {
        ...
        gitIntegration.processExecutor = processExecutorStub;
    });
    teardown(() => {
        sinon.restore();
...
UU conflicted.txt`;
    ...
    suite('File Staging', () => {
        test('should stage files successfully', async () => {
            ...
            sinon.stub(gitIntegration, 'detectRepositoryStatus').resolves({});
...
//# sourceMappingURL=GitIntegration.unit.test.js.map